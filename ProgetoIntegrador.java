...
public class ProgetoIntegrador {
    ...
    static void jogo() throws Exception { // entrada do jogo
        ...
        while (contadorDePerguntas <= perguntas.size()) {
            ...
            System.out.println( pergunta.respostaCorreta);

            if (resposta.equals(pergunta.respostaCorreta)) {
                pontos = pontos + pergunta.pontos;
                System.out.println("Resposta correta, " + nome + ".");
               
            }else if (tentativasRestantes > 0) {
                System.out.println("Resposta errada, " + nome + "! Tente novamente." + tentativasRestantes);
                tentativasRestantes--;
            } else if (tentativasRestantes == 0) {
    ...
    static void teste() throws Exception {
